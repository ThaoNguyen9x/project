...
import ModalCustomerType from "../../components/admin/Customer_Service/Customer_Type/modal.customer-type";
import ViewCustomerType from "../../components/admin/Customer_Service/Customer_Type/view.customer-type";
...
const CustomerType = () => {
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex items-center gap-3">
          <Access
            permission={ALL_PERMISSIONS.CUSTOMER_TYPES.UPDATE}
            hideChildren
          >
          ...
          <Access
            permission={ALL_PERMISSIONS.CUSTOMER_TYPES.DELETE}
            hideChildren
          >
  ...
  const fetchData = async () => {
    ...
    const res = await callGetAllCustomerTypes(query);
    if (res && res.data) {
  ...
  const handleDelete = async (id) => {
    const res = await callDeleteCustomerType(id);
  ...
  return (
    <div className="p-4 xl:p-6 min-h-full rounded-md bg-white">
      <div className="mb-5 flex items-center justify-between">
        <h2 className="text-base xl:text-xl font-bold">Loại khách hàng</h2>
        <Access permission={ALL_PERMISSIONS.CUSTOMER_TYPES.CREATE} hideChildren>
